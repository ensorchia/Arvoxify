...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Završeno učitavanje. DevTools alat je otvoren" },
		"i18n": { "loaded": "i18n su učitani" },
		"second-instance": { "receive-command": "Primljena je komanda kroz protokol: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS datoteka \"{{cssFile}}\" ne postoji, ignorišem" },
		"unresponsive": { "details": "Aplikacija se ne odaziva!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Čišćenje keširanih podataka" },
		"window": { "tried-to-render-offscreen": "Prozor je pokušao da se učita van ekrana: windowSize={{windowSize}}, displaySize={{displaySize}}, position={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Jezik",
					"submenu": { "to-help-translate": "Želite da pomognete u prevođenju? Kliknite ovde" }
				},
...
export { common, sr_default as default, language, main, plugins };
