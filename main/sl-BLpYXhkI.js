...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Nalaganje končano. DevTools odprt" },
		"i18n": { "loaded": "i18n naložen" },
		"second-instance": { "receive-command": "Prejel ukaz preko protokola: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS datoteka \"{{cssFile}}\" ne obstaja, ignoriram" },
		"unresponsive": { "details": "Neodzivna napaka!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Čiščenje predpomnilnika" },
		"window": { "tried-to-render-offscreen": "Okno se je poskusilo prikazati izven ekrana, windowSize={{windowSize}}, displaySize={{displaySize}}, position={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Jezik",
					"submenu": { "to-help-translate": "Želiš pomagati pri prevajanju? Klikni tukaj" }
				},
...
const plugins = {
	...
	"album-color-theme": {
		...
		"menu": { "color-mix-ratio": {
			"label": "Razmerje barv",
			"submenu": { "percent": "{{ratio}}%" }
		} },
	...
	"ambient-mode": {
		...
		"menu": {
			"blur-amount": {
				...
				"submenu": { "pixels": "{{blurAmount}} pikslov" }
			},
			"buffer": {
				"label": "Medpomnilnik",
			...
			"quality": {
				"label": "Kvaliteta",
				"submenu": { "pixels": "{{quality}} pikslov" }
			},
			"size": {
				"label": "Velikost",
			...
			"smoothness-transition": {
				...
				"submenu": { "during": "Med {{interpolationTime}} s" }
			},
			"use-fullscreen": { "label": "Uporablja celoten zaslon" }
		},
	...
	"api-server": {
		...
		"menu": {
			"auth-strategy": {
				...
				"submenu": {
					"auth-at-first": { "label": "Avtorizacija ob prvem zahtevku" },
					"none": { "label": "Ni avtorizacije" }
				}
			},
	...
	"captions-selector": {
		"description": "Izberi podnapise za Arvoxify zvočne posnetke",
		"menu": {
		...
		"templates": { "title": "Odpri izbiro podnapisov" }
	},
	"compact-sidebar": {
	...
	"disable-autoplay": {
		...
		"menu": { "apply-once": "Uporabi samo ob zagonu" },
	...
	"downloader": {
		...
		"name": "Prenaševalec",
		"renderer": { "can-not-update-progress": "Nemorem osvežiti napredka" },
		"templates": { "button": "Prenos" }
	},
	"exponential-volume": {
	...
	"in-app-menu": {
		...
		"menu": { "hide-dom-window-controls": "Skrije DOM gumbe za okno" },
...
export { common, sl_default as default, language, main, plugins };
