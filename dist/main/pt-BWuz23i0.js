...
const main = {
	"console": {
		...
		"second-instance": { "receive-command": "Comando recebido através do protocolo: \"{{command}}\"" },
		"theme": { "css-file-not-found": "O ficheiro CSS \"{{cssFile}}\" não existe, a ignorar" },
		"unresponsive": { "details": "Erro de falta de resposta!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "A limpar cache da aplicação" },
		"window": { "tried-to-render-offscreen": "Tentativa de desenho fora do ecrã na janela, tamanho da janela={{windowSize}}, tamanho do ecrã={{displaySize}}, posição={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Idioma",
					"submenu": { "to-help-translate": "Deseja ajudar na tradução? Clique aqui" }
				},
...
export { common, pt_default as default, language, main, plugins };
