...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Chargement terminé. DevTools ouvert" },
		"i18n": { "loaded": "i18n chargé" },
		"second-instance": { "receive-command": "Received command over protocol\xA0: \"{{command}}\"" },
		"theme": { "css-file-not-found": "Le fichier de CSS \"{{cssFile}}\" n'existe pas, ignorer" },
		"unresponsive": { "details": "Erreur\xA0: Aucune réponse!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Effacement du cache de l'application" },
		"window": { "tried-to-render-offscreen": "La fenêtre a essayé d'effectuer un rendu hors écran, windowSize={{windowSize}}, displaySize={{displaySize}}, position={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				"advanced-options": {
					...
					"submenu": {
						...
						"set-proxy": {
							...
							"prompt": {
								"label": "Entrez l'adresse proxy\xA0: (laissez vide pour désactiver)",
				...
				"language": {
					...
					"label": "Langue",
					"submenu": { "to-help-translate": "Envie d'aider à la traduction ? Cliquer ici" }
				},
				...
				"visual-tweaks": {
					...
					"submenu": {
						"custom-window-title": {
							...
							"prompt": {
								"label": "Entrés un titre de fenêtre\xA0: (Laissé vide pour déactiver)",
								"placeholder": "Exemple\xA0: Arvoxify"
							}
						},
						"like-buttons": {
							"default": "Par défaut",
...
export { common, fr_default as default, language, main, plugins };
