import { i as __require, n as __esmMin, s as __toESM, t as __commonJSMin } from "./chunk-0rTXi_Jc.js";
	...
	*/
	(function(global$1, factory) {
		...
		function convertByobReadOptions(options, context) {
			var _a$1;
			assertDictionary(options, context);
			const min = (_a$1 = options === null || options === void 0 ? void 0 : options.min) !== null && _a$1 !== void 0 ? _a$1 : 1;
			return { min: convertUnsignedLongLongWithEnforceRange(min, `${context} has member 'min' that`) };
		}
		...
		function TransformStreamDefaultControllerPerformTransform(controller, chunk) {
			...
			return transformPromiseWith(transformPromise, void 0, (r$1) => {
...
var POOL_SIZE, _Blob, Blob, fetch_blob_default;
...
var init_from = __esmMin((() => {
	import_node_domexception = /* @__PURE__ */ __toESM(require_node_domexception());
	init_file();
	init_fetch_blob();
	({stat} = promises);
	blobFromSync = (path$1, type) => fromBlob(statSync(path$1), path$1, type);
	blobFrom = (path$1, type) => stat(path$1).then((stat$1) => fromBlob(stat$1, path$1, type));
	fileFrom = (path$1, type) => stat(path$1).then((stat$1) => fromFile(stat$1, path$1, type));
	fileFromSync = (path$1, type) => fromFile(statSync(path$1), path$1, type);
	fromBlob = (stat$1, path$1, type = "") => new fetch_blob_default([new BlobDataItem({
		path: path$1,
		size: stat$1.size,
		lastModified: stat$1.mtimeMs,
		start: 0
	})], { type });
	fromFile = (stat$1, path$1, type = "") => new file_default([new BlobDataItem({
		path: path$1,
		size: stat$1.size,
		lastModified: stat$1.mtimeMs,
		start: 0
...
export { init_from as a, init_esm_min as c, init_fetch_blob as d, fileFromSync as i, file_default as l, blobFromSync as n, FormData as o, fileFrom as r, formDataToBlob as s, blobFrom as t, fetch_blob_default as u };
