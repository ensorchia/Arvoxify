...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "පූරණය අවසන්. DevTools විවෘත වී ඇත" },
		"i18n": { "loaded": "i18n පූරණය කරන ලදී" },
		"second-instance": { "receive-command": "ප්‍රෝටෝකාල් හරහා විධානය ලැබුණි: \"{{command}}\"" },
		"theme": { "css-file-not-found": "css ගොනුව \"{{cssFile}}\" නොපවතී, නොසලකා හරී" },
		"unresponsive": { "details": "ප්‍රතිචාර නොදක්වයි, දෝෂයක්\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "යෙදුමේ දත්ත සංචිතය හිස් කරමින්" },
		"window": { "tried-to-render-offscreen": "වින්ඩෝව තිරයෙන් පිටත පෙන්වීමට උත්සාහ කළේය, වින්ඩෝවේ ප්‍රමාණය={{windowSize}}, තිරයෙ ප්‍රමාණය={{displaySize}}, පිහිටීම={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "භාෂාව",
					"submenu": { "to-help-translate": "පරිවර්තනය කිරීමට උදව් කරන්න ඕනේද? මෙතන ක්ලික් කරන්න" }
				},
...
const plugins = { "adblocker": { "description": "සියලුම දැන්වීම් අවහිර කර කොටුවෙන් පිටත ලුහුබැඳීම" } };
var si_default = {
	common,
	language,
	main,
...
export { common, si_default as default, language, main, plugins };
