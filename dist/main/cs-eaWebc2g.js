...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Načítání dokončeno. Vývojářské nástroje se otevřely" },
		"i18n": { "loaded": "i18n načteno" },
		"second-instance": { "receive-command": "Přijmut příkaz přes protokol: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS soubor \"{{cssFile}}\" neexistuje, ignorováno" },
		"unresponsive": { "details": "Chyba - Aplikace nereaguje!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Čištění mezipaměti aplikace" },
		"window": { "tried-to-render-offscreen": "Okno se pokusilo vykreslit na pozadí, velikost okna = {{windowSize}}, zobrazovací velikost = {{displaySize}}, pozice = {{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Jazyk",
					"submenu": { "to-help-translate": "Chcete pomoc s překladem? Klikněte zde" }
				},
...
export { common, cs_default as default, language, main, plugins };
