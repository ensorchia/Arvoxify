...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Završeno učitavanje. DevTools je otvoren" },
		"i18n": { "loaded": "i18n je učitan" },
		"second-instance": { "receive-command": "Zaprimljena naredba preko protokola: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS datoteka \"{{cssFile}}\" ne postoji, zanemarujem" },
		"unresponsive": { "details": "Neresponzivna Pogreška!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Brisanje predmemorije aplikacije" },
		"window": { "tried-to-render-offscreen": "Prozor se pokušao prikazat van ekrana, windowSize={{windowSize}}, displaySize={{displaySize}}, position={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Jezik",
					"submenu": { "to-help-translate": "Želite pomoći sa prijevodom? Kliknite ovdje" }
				},
...
export { common, hr_default as default, language, main, plugins };
