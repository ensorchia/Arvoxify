...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Betöltés befejezve. DevTools megnyitva" },
		"i18n": { "loaded": "i18n betöltve" },
		"second-instance": { "receive-command": "Fogadott parancs a protokollon keresztül: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS fájl \"{{cssFile}}\" nem létezik, figyelmen kívül hagyva" },
		"unresponsive": { "details": "Nem válaszol!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Alkalmazás gyorsítótárának törlése" },
		"window": { "tried-to-render-offscreen": "Az ablak a képernyőn kívül próbált betölteni, ablakMéret={{windowSize}}, kijelzőMéret={{displaySize}}, pozíció={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Nyelv",
					"submenu": { "to-help-translate": "Szeretnél segíteni a fordításban? Kattints ide" }
				},
...
export { common, hu_default as default, language, main, plugins };
