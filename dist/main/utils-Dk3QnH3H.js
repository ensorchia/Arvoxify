const languageResources = async () => {
	const entries = await Promise.all([
		import("./zh-TW-Bqwx-9Uj.js").then((mod) => ({ "zh-TW": { translation: mod.default } })),
		import("./zh-CN-YlsMy2Ri.js").then((mod) => ({ "zh-CN": { translation: mod.default } })),
		import("./vi-BFu7blWD.js").then((mod) => ({ "vi": { translation: mod.default } })),
		import("./ur-CR5lm5BR.js").then((mod) => ({ "ur": { translation: mod.default } })),
		import("./uk-BmZZq9of.js").then((mod) => ({ "uk": { translation: mod.default } })),
		import("./tr-BZTl_kMV.js").then((mod) => ({ "tr": { translation: mod.default } })),
		import("./th-DsKMrnXY.js").then((mod) => ({ "th": { translation: mod.default } })),
		import("./ta-CpRMUniE.js").then((mod) => ({ "ta": { translation: mod.default } })),
		import("./sv-3WiaJDrq.js").then((mod) => ({ "sv": { translation: mod.default } })),
		import("./sr-DRRruDUs.js").then((mod) => ({ "sr": { translation: mod.default } })),
		import("./sq-CZ05tv4C.js").then((mod) => ({ "sq": { translation: mod.default } })),
		import("./sl-BLpYXhkI.js").then((mod) => ({ "sl": { translation: mod.default } })),
		import("./sk-Bd9XNo46.js").then((mod) => ({ "sk": { translation: mod.default } })),
		import("./si-DzlUr07m.js").then((mod) => ({ "si": { translation: mod.default } })),
		import("./ru-DXtJgTYp.js").then((mod) => ({ "ru": { translation: mod.default } })),
		import("./ro-DQrYw_mR.js").then((mod) => ({ "ro": { translation: mod.default } })),
		import("./pt-BWuz23i0.js").then((mod) => ({ "pt": { translation: mod.default } })),
		import("./pt-BR-CpFFPGnd.js").then((mod) => ({ "pt-BR": { translation: mod.default } })),
		import("./pl-D1DeoDwo.js").then((mod) => ({ "pl": { translation: mod.default } })),
		import("./nl-B4uR1mcZ.js").then((mod) => ({ "nl": { translation: mod.default } })),
		import("./ne-Dl2rzgOR.js").then((mod) => ({ "ne": { translation: mod.default } })),
		import("./nb-yfJRbGXC.js").then((mod) => ({ "nb": { translation: mod.default } })),
		import("./ms-COUKMk7-.js").then((mod) => ({ "ms": { translation: mod.default } })),
		import("./ml-CFXV-t1z.js").then((mod) => ({ "ml": { translation: mod.default } })),
		import("./lv-BO-IMuwS.js").then((mod) => ({ "lv": { translation: mod.default } })),
		import("./lt-Ehp4EL4R.js").then((mod) => ({ "lt": { translation: mod.default } })),
		import("./ko-C6Sf0AZm.js").then((mod) => ({ "ko": { translation: mod.default } })),
		import("./kn-B-YBJ3Lv.js").then((mod) => ({ "kn": { translation: mod.default } })),
		import("./ka-BBnbL876.js").then((mod) => ({ "ka": { translation: mod.default } })),
		import("./ja-4qUBMhkh.js").then((mod) => ({ "ja": { translation: mod.default } })),
		import("./it-NheFO2iO.js").then((mod) => ({ "it": { translation: mod.default } })),
		import("./is-Bqp7Qglx.js").then((mod) => ({ "is": { translation: mod.default } })),
		import("./id-45aOKBlL.js").then((mod) => ({ "id": { translation: mod.default } })),
		import("./hu-Cad1otkq.js").then((mod) => ({ "hu": { translation: mod.default } })),
		import("./hr-BsCFp4yV.js").then((mod) => ({ "hr": { translation: mod.default } })),
		import("./hi-Bic-3blW.js").then((mod) => ({ "hi": { translation: mod.default } })),
		import("./he-B0m24B9o.js").then((mod) => ({ "he": { translation: mod.default } })),
		import("./gl-CXnIK2-f.js").then((mod) => ({ "gl": { translation: mod.default } })),
		import("./fr-CLMHYFxv.js").then((mod) => ({ "fr": { translation: mod.default } })),
		import("./fil-ZHvi-UtQ.js").then((mod) => ({ "fil": { translation: mod.default } })),
		import("./fi-C0edSeAW.js").then((mod) => ({ "fi": { translation: mod.default } })),
		import("./fa-c34J6oHu.js").then((mod) => ({ "fa": { translation: mod.default } })),
		import("./eu-D9iOoRTe.js").then((mod) => ({ "eu": { translation: mod.default } })),
		import("./et-BMbrfbvx.js").then((mod) => ({ "et": { translation: mod.default } })),
		import("./es-BIyH9xsC.js").then((mod) => ({ "es": { translation: mod.default } })),
		import("./en-KaNDvrKe.js").then((mod) => ({ "en": { translation: mod.default } })),
		import("./el-zD0-PidH.js").then((mod) => ({ "el": { translation: mod.default } })),
		import("./de-ClH3AatF.js").then((mod) => ({ "de": { translation: mod.default } })),
		import("./da-BtXPn0r-.js").then((mod) => ({ "da": { translation: mod.default } })),
		import("./cs-eaWebc2g.js").then((mod) => ({ "cs": { translation: mod.default } })),
		import("./ca-Bt6J3YPs.js").then((mod) => ({ "ca": { translation: mod.default } })),
		import("./bs-BfIQztgr.js").then((mod) => ({ "bs": { translation: mod.default } })),
		import("./bn-CqsVL3W3.js").then((mod) => ({ "bn": { translation: mod.default } })),
		import("./bg-CXhvi86l.js").then((mod) => ({ "bg": { translation: mod.default } })),
		import("./be-D4nLW6kC.js").then((mod) => ({ "be": { translation: mod.default } })),
		import("./az-B4biamnz.js").then((mod) => ({ "az": { translation: mod.default } })),
		import("./ar-1rGiQCYe.js").then((mod) => ({ "ar": { translation: mod.default } }))
	]);
...
var Translator = class Translator extends EventEmitter {
	...
	exists(key, o = { interpolation: {} }) {
		...
		return this.resolve(key, opt)?.res !== void 0;
	}
...
const loadI18n = async () => await init({
	resources: await languageResources(),
	lng: "en",
	fallbackLng: "en",
	interpolation: { escapeValue: false }
});
const setLanguage = async (language) => await changeLanguage(language);
const t = t$1.bind(instance);
const LoggerPrefix = "[YTMusic]";
const createPlugin = (def) => def;
const createBackend = (back) => back;
const startPlugin = async (id, def, options) => {
	const lifecycle = typeof def[options.ctx] === "function" ? def[options.ctx] : def[options.ctx]?.start;
	try {
		const defContext = def[options.ctx];
		if (defContext && typeof defContext !== "function") Object.entries(defContext).forEach(([key, value]) => {
			if (typeof value === "function") defContext[key] = value.bind(defContext);
		});
		const start = performance.now();
		await lifecycle?.call(defContext, options.context);
		console.log(LoggerPrefix, t("common.console.plugins.executed-at-ms", {
			pluginName: id,
		...
		console.error(LoggerPrefix, t("common.console.plugins.execute-failed", {
			pluginName: id,
			contextName: options.ctx
		}));
		console.trace(err);
...
export { stopPlugin as a, t as c, startPlugin as i, t$1 as l, createBackend as n, loadI18n as o, createPlugin as r, setLanguage as s, LoggerPrefix as t, languageResources as u };
