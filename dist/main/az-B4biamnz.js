...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Yükləmə tamamlandı. DevTools açıldı" },
		"i18n": { "loaded": "i18n yükləndi" },
		"second-instance": { "receive-command": "Protokol üzərindən əmr alındı: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS faylı \"{{cssFile}}\" mövcud deyil, nəzərə alınmır" },
		"unresponsive": { "details": "Cavabsız Səhv!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Proqram keşi təmizlənir" },
		"window": { "tried-to-render-offscreen": "Pəncərə ekran kənarında göstərilməyə çalışıldı, PəncərəÖlçüsü={{windowSize}}, EkranÖlçüsü={{displaySize}}, Vəziyyət={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Dil",
					"submenu": { "to-help-translate": "Tərcüməyə kömək etmək istəyirsiniz? Buraya basın" }
				},
				...
				"tray": { "submenu": { "disabled": "Deaktiv edilib" } },
				"visual-tweaks": {
					"label": "Vizual düzəlişlər",
					"submenu": {
						"custom-window-title": { "prompt": { "placeholder": "Nümunə: Arvoxify" } },
						"like-buttons": {
							"default": "Standart",
							"hide": "Gizlət"
						},
...
export { common, az_default as default, language, main };
