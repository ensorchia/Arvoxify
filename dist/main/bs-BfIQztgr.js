...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Završeno učitavanje. DevTools otvoren" },
		"i18n": { "loaded": "i18n učitan" },
		"second-instance": { "receive-command": "Comanda primljena preko protokola \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS datoteka \"{{cssFile}}\" ne postoji, ignorišem" },
		"unresponsive": { "details": "Greška u aplikaciji!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Čistim predmemoriju aplikacije" },
		"window": { "tried-to-render-offscreen": "Prozor se pokušao prikazati van okvira ekrana, windowSize={{windowSize}}, displaySize={{displaySize}}, position={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Jezik",
					"submenu": { "to-help-translate": "Želite da pomognete s prijevodom? Kliknite ovdje" }
				},
...
const plugins = { "ambient-mode": { "menu": { "quality": { "label": "Kvalitet" } } } };
var bs_default = {
	common,
	language,
	main,
...
export { common, bs_default as default, language, main, plugins };
