...
const main = {
	"console": {
		"did-finish-load": { "dev-tools": "Laddning slutförd. Utvecklarverktyg öppnad" },
		"i18n": { "loaded": "i18n laddad" },
		"second-instance": { "receive-command": "Mottog kommando via protokoll: \"{{command}}\"" },
		"theme": { "css-file-not-found": "CSS-filen \"{{cssFile}}\" finns inte, ignorerar" },
		"unresponsive": { "details": "Oresponsivt fel!\n{{error}}" },
		"when-ready": { "clearing-cache-after-20s": "Rensar appens cache" },
		"window": { "tried-to-render-offscreen": "Fönstret försökte rendera utanför skärmen, windowSize={{windowSize}}, displaySize={{displaySize}}, position={{position}}" }
	},
	"dialog": {
		"hide-menu-enabled": {
		...
		"options": {
			...
			"submenu": {
				...
				"language": {
					...
					"label": "Språk",
					"submenu": { "to-help-translate": "Vill du hjälpa till att översätta? Klicka här" }
				},
					...
					"submenu": {
						"custom-window-title": {
							...
							"prompt": {
								...
								"placeholder": "Exempelvis: Arvoxify"
							}
						},
						"like-buttons": {
							"default": "Standard",
...
export { common, sv_default as default, language, main, plugins };
